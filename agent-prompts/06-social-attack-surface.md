# Agent Prompt: Social Attack Surface
*Paste this prompt into Claude, ChatGPT, or any capable AI assistant. The agent will help you understand your public exposure and build a reduction plan.*
...
2. What city and state do you currently live in?
3. Are you a public figure, professional with a public profile, or private individual?
4. What social media platforms are you active on?
5. Have you ever had a social media presence under your real name that you've since deleted or abandoned?
...
- Image search instructions for my profile photo

**Step 2: Data broker exposure**
Based on what I tell you about my name and location, tell me:
- Which data broker sites are highest priority for me to check
- The exact name and URL to search on each
- The opt-out process or where to find it for each one
- Whether an automated service would be worth it given my exposure level

**Step 3: Social media audit**
For each platform I'm active on:
- Ask me what my current privacy settings are (I'll describe them)
- Tell me specifically what to change on each one
- Ask about old posts, location tagging, and tagged photos from others
- Tell me what an adversary could infer from my current settings

**Step 4: Reduce future exposure**
Ask me:
- What email address do I give out when signing up for services?
- Do I use location tagging in posts?
- Do I use the same username or profile photo across multiple platforms?

Then give me specific recommendations for each.
