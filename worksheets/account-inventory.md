...
Run every email address in your inventory through [haveibeenpwned.com](https://haveibeenpwned.com).

| Email Address | Breach Count | Services Breached | Action Taken |
|---|---|---|---|
| | | | |
| | | | |
| | | | |
...
Accounts you've decided to delete. Track so you don't lose the thread.

| Service | Date Deletion Requested | Confirmed Deleted? | Notes |
|---|---|---|---|
| | | | |
| | | | |
| | | | |
...
## Unknown Account Flags

Accounts you found evidence of (in email, statements, etc.) but can't access or verify the status of.

| Service | Evidence Found (where) | Email Used (if known) | Next Step |
|---|---|---|---|
| | | | |
| | | | |
...
## Email Addresses Review

| Email Address | Provider | Status | Accounts Associated | Controls recovery for? |
|---|---|---|---|---|
| | | Active / Dormant / Inaccessible | | |
